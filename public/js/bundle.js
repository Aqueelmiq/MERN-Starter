...
var HomeActions = function () {
    function HomeActions() {
        ...
        this.generateActions('onSomeThingHappened');
    }

    _createClass(HomeActions, [{
        key: 'onSomeThing',
        value: function onSomeThing() {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'p',
                    null,
                    ' This is a good place to start your Full stack Javascript App Based on MongoDB, Express, React, NodeJS (MERN Stack).'
                ),
                _react2.default.createElement(
                    'p',
                    null,
                    ...
                    '  - for hot-reloading during dev phase.'
                ),
                _react2.default.createElement(
                    'h3',
                    null,
                ...
                _react2.default.createElement(
                    'li',
                    null,
                    ' Main style sheet is at ./app/stylesheets/main.less '
                ),
                _react2.default.createElement(
                    'li',
                    null,
                    ' Your server side (nodeJS) code is in ./server.js '
                ),
                _react2.default.createElement(
                    'li',
                    null,
                    ' ./models is where you MongoDB Schemas goes. '
                ),
                _react2.default.createElement(
                    'li',
                    null,
                    ' ./app has actions, components and stores for React Code.'
                ),
                _react2.default.createElement(
                    'li',
                    null,
                    ' ./public is where compiled public source code goes.'
                )
            );
        }
    }]);
...
},{"./routes":6,"history/lib/createBrowserHistory":16,"react":"react","react-dom":"react-dom","react-router":"react-router"}],6:[function(require,module,exports){
'use strict';
...
var HomeStore = function () {
    ...
    _createClass(HomeStore, [{
        key: 'onSomeThingHappened',
        value: function onSomeThingHappened(data) {
            this.variable = data;
        }
    }]);
...
},{"./Actions":11,"./DOMStateStorage":13,"./DOMUtils":14,"./ExecutionEnvironment":15,"./createDOMHistory":17,"./parsePath":22,"_process":25,"invariant":24}],17:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./DOMUtils":14,"./ExecutionEnvironment":15,"./createHistory":18,"_process":25,"invariant":24}],18:[function(require,module,exports){
